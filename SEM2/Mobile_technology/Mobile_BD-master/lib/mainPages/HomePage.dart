                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: ButtonStyle(
                            backgroundColor:
                                MaterialStateProperty.all<Color>(Color.fromARGB(255, 60, 237, 0))),
                        child: Align(
                            alignment: Alignment.center,
                            child: Text(
                              "Сайн уу ${userInfo['u_name']}",
                              style: TextStyle(
                                  fontSize: 24,
                          ...
                          child: Align(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  " ${upcomingTransactions[index][2].difference(DateTime.now()).inDays.toString()} өдөрт",
                                  style: TextStyle(
